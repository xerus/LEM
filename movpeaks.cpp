    ...
    int change_frequency = 5000; /* number of evaluations between changes. change_frequency 
    ...
    double height_severity=1.0; /* severity of height changes, larger numbers 
    ...
    int number_of_peaks = 200; /* number of peaks in the landscape */  
    ...
    void init_peaks (const int dimensions, const int peaks, const int freq)  
    {  
      int i,j;  
      double dummy;  

      geno_size = dimensions;
